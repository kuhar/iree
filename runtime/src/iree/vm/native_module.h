...
// Basic target function type (3 params) - kept for API compatibility.
typedef iree_status_t(IREE_API_PTR* iree_vm_native_function_target_t)(
    iree_vm_stack_t* stack, void* module, void* module_state);

// Extended target function type (5 params) used by shim-generated functions.
// This is what functions created with IREE_VM_ABI_EXPORT actually use.
...
typedef struct iree_vm_native_function_ptr_t {
  ...
  // Target function passed to the shim (uses extended 5-param signature).
