...
// This file implements logic for lowering StableHLO dialect to Linalg dialect.
...
struct StableHloLegalizeToLinalgPass
    : public impl::StableHloLegalizeToLinalgPassBase<StableHloLegalizeToLinalgPass> {
...
void populateStableHloToLinalgConversionPattern(MLIRContext* context,
  ...
  if (enablePrimitiveOps) {
    patterns->add<
      ...
      PointwiseToLinalgMapConverter<mhlo::CopyOp>, // FIXME(Jakub)
      ...
      PointwiseToLinalgMapConverter<mhlo::TanOp>, // FIXME(Jakub)
    ...
    patterns->add<
      ...
      PointwiseToLinalgConverter<mhlo::CopyOp>, // FIXME(Jakub)
      ...
      PointwiseToLinalgConverter<mhlo::TanOp>, // FIXME(Jakub)
...
std::unique_ptr<OperationPass<func::FuncOp>> createLegalizeStableHloToLinalgPass(
    bool enablePrimitiveOps) {
  StableHloLegalizeToLinalgPassOptions options;
  options.enablePrimitiveOps = enablePrimitiveOps;
  return std::make_unique<StableHloLegalizeToLinalgPass>(options);
}
