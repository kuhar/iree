// Configuration(subgroup_size=64, workgroup_size=[64, 2, 1], intrinsic='#iree_gpu.mfma_layout<F16_16x16x16_F32>', tile_sizes=[64, 160, 64], subgroup_m_count=2, subgroup_n_count=1, subgroup_m_tile_count=2, subgroup_n_tile_count=10, subgroup_k_tile_count=4)
    ...
    hal.executable.variant public @rocm_hsaco_fb target(<"rocm", "rocm-hsaco-fb", {mma_intrinsics = [#iree_gpu.mfma_layout<F16_16x16x16_F32>, #iree_gpu.mfma_layout<F16_32x32x8_F32>], target_arch = "gfx942", ukernels = "none"}>) {
      ...
      builtin.module {
        func.func @main$async_dispatch_222_matmul_transpose_b_2048x1280x1280_f16xf16xf32() {
          ...
          %19 = linalg.fill {lowering_config = #iree_codegen.lowering_config<tile_sizes = [[64, 160, 64]]>} ins(%cst : f32) outs(%18 : tensor<2048x1280xf32>) -> tensor<2048x1280xf32>
