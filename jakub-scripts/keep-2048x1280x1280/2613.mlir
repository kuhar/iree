// Configuration(subgroup_size=64, workgroup_size=[128, 2, 1], intrinsic='#iree_gpu.mfma_layout<F16_16x16x16_F32>', tile_sizes=[256, 64, 64], subgroup_m_count=8, subgroup_n_count=2, subgroup_m_tile_count=2, subgroup_n_tile_count=2, subgroup_k_tile_count=4)
